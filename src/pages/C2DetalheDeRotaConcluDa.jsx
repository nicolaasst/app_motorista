...
export default function C2DetalheDeRotaConcluDa() {
  useEffect(() => { document.title = 'RotaPro Driver'; }, []);
  return (
    <ScreenFrame screenId="c.2_detalhe_de_rota_conclu_da"><PageRuntime screenId="c.2_detalhe_de_rota_conclu_da">
      <div>
  <header className="fixed top-0 inset-x-0 z-50 bg-surface/90 backdrop-blur-xl pt-safe"><div className="h-16 px-margin flex items-center justify-between shadow-[0_1px_8px_rgba(0,0,0,0.04)]"><div className="flex items-center gap-space-sm"><img alt="Logotipo RotaPro Driver" className="h-8 w-auto object-contain" src="/screens/logotipo_rotapro_driver.png" /><div className="flex flex-col"><span className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">RotaPro</span><span className="font-headline-sm text-headline-sm text-on-surface leading-tight">Rota</span></div></div><div className="flex items-center gap-space-sm"><button aria-label="Notificações" className="relative w-11 h-11 rounded-full flex items-center justify-center text-on-surface hover:bg-surface-container transition-colors"><span className="material-symbols-outlined text-[24px]">notifications</span><span className="absolute top-2 right-2 flex h-4 w-4 items-center justify-center rounded-full bg-primary-container text-on-primary font-label-sm text-[10px] ring-2 ring-surface">3</span></button><div className="relative flex items-center justify-center"><img alt="Profile" className="w-8 h-8 rounded-full object-cover ring-2 ring-primary/20" src="/screens/logotipo_rotapro_driver.png" /><span className="absolute bottom-0 right-0 w-2.5 h-2.5 rounded-full bg-primary-container ring-1 ring-surface" /></div></div></div></header><main className="flex-1 flex flex-col relative w-full pt-16 pb-24 bg-surface px-margin"><div className="flex flex-col w-full pb-20">
      ...
      <div className="flex items-center justify-between py-space-sm mb-space-sm">
        <a className="inline-flex items-center gap-space-xs py-2 px-3 rounded-full bg-surface-container-lowest text-on-surface shadow-sm active:bg-surface-container transition-colors" href="#">
        ...
        <div className="flex items-center gap-space-xs">
          <button className="w-10 h-10 rounded-full bg-surface-container-lowest flex items-center justify-center text-on-surface shadow-sm active:bg-surface-container transition-colors" title="Compartilhar">
            <span className="material-symbols-outlined text-[20px]">share</span>
          </button>
          <button className="w-10 h-10 rounded-full bg-surface-container-lowest flex items-center justify-center text-on-surface shadow-sm active:bg-surface-container transition-colors" title="Exportar Resumo">
      ...
      <div className="bg-surface-container-lowest rounded-lg p-space-md shadow-sm mb-space-md">
        <div className="flex items-center justify-between mb-space-xs">
          <div className="flex items-center gap-space-xs">
            ...
            <span className="font-code-md text-code-md text-on-surface font-bold">ROM-2024-88412</span>
          </div>
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-surface-container text-primary">
            <span className="w-2 h-2 rounded-full bg-primary-container" />
            <span className="font-label-sm text-label-sm uppercase tracking-wider font-bold">Rota Concluída</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between pt-space-xs bg-surface-container-low p-space-sm rounded">
          <div className="flex flex-col">
            <span className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">Veículo Operacional</span>
            <span className="font-code-sm text-code-sm text-on-surface font-bold">Sprinter • BRA-2E19</span>
          </div>
          <div className="h-6 w-[1px] bg-secondary-fixed-dim/40" />
          <div className="flex flex-col items-end">
            <span className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">Odômetro Auditado</span>
            <span className="font-code-sm text-code-sm text-on-surface font-bold">142.850 → 142.898 km</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-surface-container-lowest rounded-lg p-space-sm shadow-sm mb-space-md overflow-hidden relative">
        <div className="flex items-center justify-between px-space-xs pb-space-xs">
          <div className="flex items-center gap-1.5">
            ...
            <span className="font-headline-sm text-headline-sm text-on-surface">Replay de Trajeto</span>
          </div>
        ...
        <div className="relative w-full h-64 rounded bg-surface-container-high overflow-hidden shadow-inner mt-1">
          <div className="w-full h-full bg-cover bg-center absolute inset-0 opacity-70" data-location="São Paulo, Brazil" style={{}} />
          {/* Simulated Vector Route Path & Milestones Overlay */}
          <svg className="absolute inset-0 w-full h-full pointer-events-none" fill="none" viewBox="0 0 360 256">
            {/* Route Polyline (Audit Vivid Green) */}
            <path className="drop-shadow-sm" d="M 40,210 Q 70,180 95,150 T 150,130 T 210,165 T 265,115 T 310,70 T 240,45 T 160,75 Z" stroke="#00B000" strokeDasharray="1 0" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
            {/* Depot: Doca Central */}
            ...
            <g transform="translate(87, 142)">
              ...
              <text fill="#FFFFFF" fontFamily="'Space Mono'" fontSize="8" fontWeight="bold" textAnchor="middle" x="8" y="11">1</text>
            </g>
            {/* Stop 2 (Green Pin) */}
            <g transform="translate(142, 122)">
              <circle cx="8" cy="8" fill="#00B000" r="7" stroke="#FFFFFF" strokeWidth="2" />
              <text fill="#FFFFFF" fontFamily="'Space Mono'" fontSize="8" fontWeight="bold" textAnchor="middle" x="8" y="11">2</text>
            </g>
            {/* Stop 3 (Green Pin) */}
            <g transform="translate(202, 157)">
              <circle cx="8" cy="8" fill="#00B000" r="7" stroke="#FFFFFF" strokeWidth="2" />
              <text fill="#FFFFFF" fontFamily="'Space Mono'" fontSize="8" fontWeight="bold" textAnchor="middle" x="8" y="11">3</text>
            </g>
            {/* Stop 4 (Green Pin) */}
            <g transform="translate(257, 107)">
              <circle cx="8" cy="8" fill="#00B000" r="7" stroke="#FFFFFF" strokeWidth="2" />
              <text fill="#FFFFFF" fontFamily="'Space Mono'" fontSize="8" fontWeight="bold" textAnchor="middle" x="8" y="11">4</text>
            </g>
            {/* Stop 5 (Exception Red Pin) */}
            <g transform="translate(302, 62)">
              <circle cx="8" cy="8" fill="#BA1A1A" r="8" stroke="#FFFFFF" strokeWidth="2" />
              <text fill="#FFFFFF" fontFamily="'Space Mono'" fontSize="8" fontWeight="bold" textAnchor="middle" x="8" y="11">5</text>
            </g>
          </svg>
          ...
          <div className="absolute top-2 right-2 flex flex-col gap-1">
            <button aria-label="Aumentar zoom" className="w-8 h-8 rounded-full bg-surface-container-lowest text-on-surface flex items-center justify-center shadow">
              <span className="material-symbols-outlined text-[18px]">add</span>
            </button>
            <button aria-label="Diminuir zoom" className="w-8 h-8 rounded-full bg-surface-container-lowest text-on-surface flex items-center justify-center shadow">
        ...
        <div className="mt-space-sm p-space-sm bg-surface-container-low rounded flex flex-col gap-2">
          <div className="flex items-center justify-between">
            <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-inverse-surface text-inverse-on-surface font-label-md text-label-md active:bg-secondary transition-colors" id="replayToggleBtn">
              <span className="material-symbols-outlined text-[18px] text-primary-fixed" id="replayIcon">play_arrow</span>
              <span id="replayStatusText">Replay do Trajeto</span>
            </button>
            <span className="font-code-sm text-code-sm text-on-surface-variant font-bold" id="replayTimer">06h 45m (Final)</span>
          </div>
          {/* Interactive Progress Scrubber */}
          <div className="flex items-center gap-2">
            <span className="font-code-sm text-[10px] text-on-surface-variant">07:30</span>
            <input aria-label="Barra de tempo do trajeto" className="w-full accent-primary h-1.5 bg-surface-container-highest rounded cursor-pointer" id="replaySlider" max="100" min="0" type="range" defaultValue="100" />
      ...
      <div className="grid grid-cols-2 gap-space-sm mb-space-md">
        <div className="bg-surface-container-lowest rounded-lg p-space-md shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between text-on-surface-variant mb-space-xs">
            <span className="font-label-sm text-label-sm uppercase tracking-wider">Paradas Totais</span>
            <span className="material-symbols-outlined text-[20px]">pin_drop</span>
          </div>
          <div className="font-display-lg text-display-lg text-on-surface font-black">18</div>
          <div className="font-body-sm text-body-sm text-on-surface-variant mt-1">100% roteirizadas</div>
        </div>
        <div className="bg-surface-container-lowest rounded-lg p-space-md shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between text-primary mb-space-xs">
            <span className="font-label-sm text-label-sm uppercase tracking-wider text-on-surface-variant">Sucesso</span>
            <span className="material-symbols-outlined text-[20px]">check_circle</span>
          </div>
          <div className="font-display-lg text-display-lg text-primary font-black">17 <span className="text-body-md font-bold text-on-surface-variant">/ 94.4%</span></div>
          <div className="font-body-sm text-body-sm text-on-surface-variant mt-1">17 canhotos validados</div>
        </div>
        <div className="bg-surface-container-lowest rounded-lg p-space-md shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between text-error mb-space-xs">
            <span className="font-label-sm text-label-sm uppercase tracking-wider text-on-surface-variant">Ocorrências</span>
        ...
        <div className="bg-surface-container-lowest rounded-lg p-space-md shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between text-on-surface-variant mb-space-xs">
            <span className="font-label-sm text-label-sm uppercase tracking-wider">Média / Parada</span>
            <span className="material-symbols-outlined text-[20px]">timer</span>
          </div>
          <div className="font-display-lg text-display-lg text-on-surface font-black">14 <span className="text-body-md font-bold text-on-surface-variant">min</span></div>
          <div className="font-body-sm text-body-sm text-on-surface-variant mt-1">Dentro da meta SLA</div>
        </div>
      </div>
      {/* Timeline Audit Stop Breakdown */}
      <div className="flex items-center justify-between mb-space-xs">
        <div className="flex items-center gap-1.5">
          <span className="material-symbols-outlined text-[20px] text-on-surface-variant">format_list_numbered</span>
          <h3 className="font-headline-sm text-headline-sm text-on-surface">Linha do Tempo de Paradas</h3>
        </div>
        <span className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">Modo Auditoria</span>
      </div>
      <div className="flex flex-col gap-space-sm mb-space-lg">
        ...
        <div className="bg-surface-container-lowest rounded-lg p-space-md shadow-sm flex flex-col gap-2">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-2">
              <span className="w-7 h-7 rounded-full bg-inverse-surface text-inverse-on-surface font-code-sm text-code-sm flex items-center justify-center font-bold">#01</span>
              <div>
                <h4 className="font-headline-sm text-headline-sm text-on-surface leading-tight">Hospital Sírio-Libanês</h4>
                <span className="font-body-sm text-body-sm text-on-surface-variant">Rua Dona Adma Jafet, 115 - Bela Vista</span>
              </div>
            </div>
            <span className="px-2.5 py-0.5 rounded-full bg-surface-container text-primary font-label-sm text-label-sm font-bold flex items-center gap-1">
              <span className="w-1.5 h-1.5 rounded-full bg-primary-container" />08:42
            </span>
          </div>
          <div className="flex items-center justify-between pt-2 text-on-surface-variant font-body-sm text-body-sm bg-surface-container-low p-2 rounded">
            <span>Recebido: <b className="text-on-surface">Carlos M. (Farmácia Central)</b></span>
        ...
        <div className="bg-surface-container-lowest rounded-lg p-space-md shadow-sm flex flex-col gap-2">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-2">
              <span className="w-7 h-7 rounded-full bg-inverse-surface text-inverse-on-surface font-code-sm text-code-sm flex items-center justify-center font-bold">#02</span>
              <div>
                <h4 className="font-headline-sm text-headline-sm text-on-surface leading-tight">Drogaria São Paulo Consolação</h4>
                <span className="font-body-sm text-body-sm text-on-surface-variant">Rua da Consolação, 2140 - Cerqueira César</span>
              </div>
            </div>
            <span className="px-2.5 py-0.5 rounded-full bg-surface-container text-primary font-label-sm text-label-sm font-bold flex items-center gap-1">
              <span className="w-1.5 h-1.5 rounded-full bg-primary-container" />09:15
            </span>
          </div>
          <div className="flex items-center justify-between pt-2 text-on-surface-variant font-body-sm text-body-sm bg-surface-container-low p-2 rounded">
            <span>Recebido: <b className="text-on-surface">Amanda S. (Gerência)</b></span>
            <button className="text-primary font-label-md text-label-md flex items-center gap-0.5">
              <span>Ver Comprovante</span>
              <span className="material-symbols-outlined text-[16px]">chevron_right</span>
            </button>
        ...
        <div className="bg-surface-container-lowest rounded-lg p-space-md shadow-sm flex flex-col gap-2">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-2">
              <span className="w-7 h-7 rounded-full bg-inverse-surface text-inverse-on-surface font-code-sm text-code-sm flex items-center justify-center font-bold">#03</span>
              <div>
                <h4 className="font-headline-sm text-headline-sm text-on-surface leading-tight">Clínica Médica Paulista</h4>
                <span className="font-body-sm text-body-sm text-on-surface-variant">Av. Paulista, 1842 - Conjunto 42</span>
              </div>
            </div>
            <span className="px-2.5 py-0.5 rounded-full bg-surface-container text-primary font-label-sm text-label-sm font-bold flex items-center gap-1">
              <span className="w-1.5 h-1.5 rounded-full bg-primary-container" />10:05
            </span>
          </div>
          <div className="flex items-center justify-between pt-2 text-on-surface-variant font-body-sm text-body-sm bg-surface-container-low p-2 rounded">
            <span>Recebido: <b className="text-on-surface">Marcelo T. (Recepção)</b></span>
            <button className="text-primary font-label-md text-label-md flex items-center gap-0.5">
              <span>Ver Comprovante</span>
              <span className="material-symbols-outlined text-[16px]">chevron_right</span>
            </button>
        ...
        <div className="bg-surface-container-lowest rounded-lg p-space-md shadow-sm flex flex-col gap-2">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-2">
              <span className="w-7 h-7 rounded-full bg-inverse-surface text-inverse-on-surface font-code-sm text-code-sm flex items-center justify-center font-bold">#04</span>
              <div>
                <h4 className="font-headline-sm text-headline-sm text-on-surface leading-tight">Laboratório Fleury</h4>
                <span className="font-body-sm text-body-sm text-on-surface-variant">Rua Cincinato Braga, 282 - Paraíso</span>
              </div>
            </div>
            <span className="px-2.5 py-0.5 rounded-full bg-surface-container text-primary font-label-sm text-label-sm font-bold flex items-center gap-1">
              <span className="w-1.5 h-1.5 rounded-full bg-primary-container" />11:20
            </span>
          </div>
          <div className="flex items-center justify-between pt-2 text-on-surface-variant font-body-sm text-body-sm bg-surface-container-low p-2 rounded">
            <span>Recebido: <b className="text-on-surface">Patricia R. (Triagem Geral)</b></span>
            <button className="text-primary font-label-md text-label-md flex items-center gap-0.5">
              <span>Ver Comprovante</span>
              <span className="material-symbols-outlined text-[16px]">chevron_right</span>
            </button>
        ...
        <div className="bg-surface-container-lowest rounded-lg p-space-md shadow-sm flex flex-col gap-2 relative overflow-hidden">
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-2">
              <span className="w-7 h-7 rounded-full bg-error text-on-error font-code-sm text-code-sm flex items-center justify-center font-bold">#05</span>
              <div>
                <h4 className="font-headline-sm text-headline-sm text-on-surface leading-tight">Farmácia Santa Clara Ltda</h4>
                <span className="font-body-sm text-body-sm text-on-surface-variant">Rua Vergueiro, 905 - Liberdade</span>
              </div>
            </div>
            <span className="px-2.5 py-0.5 rounded-full bg-error-container text-on-error-container font-label-sm text-label-sm font-bold flex items-center gap-1">
              <span className="w-1.5 h-1.5 rounded-full bg-error" />Falha
            </span>
          </div>
          <div className="p-space-sm bg-error-container/20 rounded flex flex-col gap-1 text-on-error-container">
            ...
            <span className="font-body-sm text-body-sm text-on-surface-variant">1 volume farmacêutico recolhido e devolvido à Doca Central.</span>
          </div>
        ...
        <div className="bg-surface-container rounded-lg p-space-md flex items-center justify-between text-on-surface-variant">
          <div className="flex items-center gap-2">
            ...
            <span className="font-body-sm text-body-sm">Paradas #06 até #18 concluídas normalmente</span>
          </div>
          <span className="font-code-sm text-code-sm font-bold text-on-surface">13 paradas</span>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center gap-2 py-2 px-4 rounded-full bg-surface-container-low text-on-surface-variant mb-space-md mx-auto shadow-inner">
        ...
        <span className="font-label-sm text-label-sm font-bold uppercase tracking-wider">Dados auditados e arquivados no TMS</span>
      </div>
