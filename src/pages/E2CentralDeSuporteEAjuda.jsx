...
export default function E2CentralDeSuporteEAjuda() {
  ...
  return (
    <ScreenFrame screenId="e.2_central_de_suporte_e_ajuda"><PageRuntime screenId="e.2_central_de_suporte_e_ajuda">
      <div>
  <header className="fixed top-0 inset-x-0 z-50 bg-surface/90 backdrop-blur-xl pt-safe"><div className="h-16 px-margin flex items-center justify-between shadow-[0_1px_8px_rgba(0,0,0,0.04)]"><div className="flex items-center gap-space-sm"><a aria-label="Voltar para o Perfil" className="w-10 h-10 -ml-2 rounded-full flex items-center justify-center text-on-surface hover:bg-surface-container active:scale-95 transition-all" data-path="perfil" href="#"><span className="material-symbols-outlined text-[24px]">arrow_back</span></a><div className="flex flex-col"><span className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">RotaPro</span><span className="font-headline-sm text-headline-sm text-on-surface leading-tight">Suporte</span></div></div><div className="flex items-center gap-space-sm"><button aria-label="Notificações" className="relative w-11 h-11 rounded-full flex items-center justify-center text-on-surface hover:bg-surface-container transition-colors"><span className="material-symbols-outlined text-[24px]">notifications</span><span className="absolute top-2 right-2 flex h-4 w-4 items-center justify-center rounded-full bg-primary-container text-on-primary font-label-sm text-[10px] ring-2 ring-surface">3</span></button><div className="relative flex items-center justify-center"><img alt="Lucas Silveira" className="w-8 h-8 rounded-full object-cover ring-2 ring-primary/20" src="/screens/logotipo_rotapro_driver.png" /><span className="absolute bottom-0 right-0 w-2.5 h-2.5 rounded-full bg-primary-container ring-1 ring-surface" /></div></div></div></header><main className="flex-1 flex flex-col relative w-full pt-16 pb-safe bg-surface px-margin"><div className="flex flex-col w-full pb-10 space-y-space-md">
      ...
      <div className="flex flex-col gap-3">
        ...
        <button className="w-full h-14 rounded-full bg-primary-container text-on-primary font-label-lg text-label-lg flex items-center justify-center gap-2 shadow-[0_8px_24px_rgba(0,176,0,0.28)] active:bg-primary transition-all" id="open-ticket-modal-btn">
          <span className="material-symbols-outlined text-[22px]">add_circle</span>
          <span>+ Abrir Novo Chamado</span>
        </button>
        {/* Category Chips Grid */}
        <div className="grid grid-cols-2 gap-2 pt-1">
          <button className="flex flex-col items-start p-3 rounded-xl bg-surface-container-lowest shadow-sm hover:bg-surface-container active:scale-[0.98] transition-all text-left">
      ...
      <div className="flex flex-col gap-3 pt-2">
        ...
        <div className="flex flex-col gap-2" id="faq-list">
          ...
          <div className="bg-surface-container-lowest rounded-xl overflow-hidden shadow-sm transition-all">
            <button className="faq-toggle w-full p-4 flex items-center justify-between text-left gap-3 focus:outline-none" type="button">
      ...
      <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm hidden flex items-end justify-center" id="ticket-modal">
        <div className="w-full bg-surface-container-lowest rounded-t-xl p-5 shadow-2xl flex flex-col gap-4 animate-in slide-in-from-bottom duration-200">
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="w-8 h-8 rounded-full bg-surface-container flex items-center justify-center text-on-surface" id="close-modal-btn">
          ...
          <div className="flex flex-col gap-3">
            <div>
              ...
              <div className="h-13 bg-surface-container-low rounded-xl px-4 flex items-center">
                <span className="font-body-md text-body-md text-on-surface">Dúvidas em Pagamento / Recibo</span>
              </div>
            </div>
            <div>
              <label className="font-label-sm text-label-sm text-on-surface-variant mb-1 block">Descrição da Ocorrência</label>
              <textarea className="w-full bg-surface-container-low rounded-xl p-3 font-body-md text-body-md text-on-surface outline-none resize-none placeholder:text-on-secondary-container" placeholder="Descreva sucintamente o número da rota e o ocorrido..." rows="3" defaultValue={""} />
            </div>
            <button className="w-full h-14 rounded-full bg-primary-container text-on-primary font-label-lg text-label-lg flex items-center justify-center gap-2 shadow-md active:bg-primary transition-all mt-1" id="submit-ticket-btn">
