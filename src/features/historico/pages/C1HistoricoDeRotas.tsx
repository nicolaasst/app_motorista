...
export default function C1HistoricoDeRotas() {
          ...
          <div className="flex flex-col w-full space-y-space-md">
            ...
            <div className="flex items-center justify-between pt-space-xs px-space-xs">
              <div className="flex flex-col">
                ...
                <span className="font-body-sm text-body-sm text-secondary">
                  Registro operacional de turnos e viagens
                </span>
              </div>
            ...
            <div className="relative overflow-hidden bg-surface-container-lowest rounded-lg p-space-md shadow-sm">
              ...
              <div className="flex items-center justify-between pb-space-sm">
                ...
                <span className="font-code-sm text-code-sm px-2.5 py-0.5 rounded-full bg-surface-container text-secondary">
                  24 Rotas
                </span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 pt-space-xs">
                <div className="flex flex-col p-2.5 rounded-DEFAULT bg-surface-container-low">
                  ...
                  <span className="font-code-md text-code-md text-on-surface mt-0.5">
                    412 <span className="font-body-sm text-[10px] text-primary">paradas</span>
                  </span>
                ...
                <div className="flex flex-col p-2.5 rounded-DEFAULT bg-surface-container-low">
                  ...
                  <span className="font-code-md text-code-md text-on-surface mt-0.5">
                    1.140 <span className="font-body-sm text-[10px] text-secondary">km</span>
                  </span>
                ...
                <div className="flex flex-col p-2.5 rounded-DEFAULT bg-surface-container-low">
                  ...
                  <span className="font-code-md text-code-md text-on-surface mt-0.5">
                    162 <span className="font-body-sm text-[10px] text-secondary">horas</span>
                  </span>
            ...
            <div className="flex flex-col space-y-space-sm">
              <div className="relative flex items-center w-full">
                <span className="material-symbols-outlined absolute left-4 text-secondary text-[22px] pointer-events-none">
                  search
                </span>
                <input
                  className="w-full h-12 pl-12 pr-11 bg-surface-container-lowest rounded-full font-body-md text-body-md text-on-surface placeholder:text-secondary shadow-sm focus:outline-none focus:bg-surface-container-lowest"
                  id="route-search"
                  placeholder="Buscar romaneio, data ou bairro..."
                  type="text"
                />
                <button
                  aria-label="Limpar busca"
                  className="absolute right-3 w-8 h-8 rounded-full flex items-center justify-center text-secondary hover:text-on-surface hover:bg-surface-container transition-colors hidden"
                  id="clear-search-btn"
                >
              ...
              <div className="flex items-center gap-2 overflow-x-auto no-scrollbar pb-1 pt-0.5">
                <button
                  className="filter-chip active flex items-center gap-1.5 h-9 px-4 rounded-full bg-inverse-surface text-inverse-on-surface font-label-md text-label-md shrink-0 shadow-sm transition-all"
                  data-filter="all"
                >
                ...
                <button
                  className="filter-chip flex items-center gap-1.5 h-9 px-4 rounded-full bg-surface-container-lowest text-secondary hover:text-on-surface font-label-md text-label-md shrink-0 shadow-sm transition-all"
                  data-filter="recent"
                >
                ...
                <button
                  aria-label="Filtro de calendário personalizado"
                  className="flex items-center justify-center w-9 h-9 rounded-full bg-surface-container-lowest text-secondary hover:text-on-surface shrink-0 shadow-sm"
                  id="open-date-picker"
                >
            ...
            <div className="flex flex-col space-y-space-md" id="routes-container">
              ...
              <div
                className="route-item bg-surface-container-lowest rounded-lg p-space-md shadow-sm transition-transform active:scale-[0.99] cursor-pointer"
                data-code="ROM-2024-88412"
                data-neighborhood="Paulista"
                onClick={() => navigate('/historico/ROM-2024-88412')}
                onKeyDown={(event) =>
                  handleCardKeyDown(event, () => navigate('/historico/ROM-2024-88412'))
                }
                role="button"
                tabIndex={0}
              >
              ...
              <div
                className="route-item bg-surface-container-lowest rounded-lg p-space-md shadow-sm transition-transform active:scale-[0.99] cursor-pointer"
                data-code="ROM-2024-88390"
                data-neighborhood="Pinheiros"
                onClick={() => navigate('/historico/ROM-2024-88390')}
                onKeyDown={(event) =>
                  handleCardKeyDown(event, () => navigate('/historico/ROM-2024-88390'))
                }
                role="button"
                tabIndex={0}
              >
                ...
                <div className="mt-3.5 p-3 rounded-DEFAULT bg-surface-container-low flex items-center justify-between">
                  <div className="flex flex-col">
                    <span className="font-body-sm text-[11px] text-secondary">Paradas</span>
                    <span className="font-code-md text-code-md text-on-surface">
                      22 <span className="font-body-sm text-[11px] text-primary">(22 ok)</span>
                    </span>
                  </div>
                  <div className="flex flex-col items-center">
                    <span className="font-body-sm text-[11px] text-secondary">Percurso</span>
              ...
              <div
                className="route-item bg-surface-container-lowest rounded-lg p-space-md shadow-sm transition-transform active:scale-[0.99] cursor-pointer"
                data-code="ROM-2024-88345"
                data-has-issue="true"
                data-neighborhood="Centro"
                onClick={() => navigate('/historico/ROM-2024-88345')}
                onKeyDown={(event) =>
                  handleCardKeyDown(event, () => navigate('/historico/ROM-2024-88345'))
                }
                role="button"
                tabIndex={0}
              >
                ...
                <div className="mt-3.5 p-3 rounded-DEFAULT bg-surface-container-low flex items-center justify-between">
                  <div className="flex flex-col">
                    <span className="font-body-sm text-[11px] text-secondary">Paradas</span>
                    <span className="font-code-md text-code-md text-on-surface">
                      20 <span className="font-body-sm text-[11px] text-error">(2 ausentes)</span>
                    </span>
                  </div>
                  <div className="flex flex-col items-center">
                    <span className="font-body-sm text-[11px] text-secondary">Percurso</span>
              ...
              <div
                className="route-item bg-surface-container-lowest rounded-lg p-space-md shadow-sm transition-transform active:scale-[0.99] cursor-pointer"
                data-code="ROM-2024-88310"
                data-neighborhood="Moema"
                onClick={() => navigate('/historico/ROM-2024-88310')}
                onKeyDown={(event) =>
                  handleCardKeyDown(event, () => navigate('/historico/ROM-2024-88310'))
                }
                role="button"
                tabIndex={0}
              >
                ...
                <div className="mt-3.5 p-3 rounded-DEFAULT bg-surface-container-low flex items-center justify-between">
                  <div className="flex flex-col">
                    <span className="font-body-sm text-[11px] text-secondary">Paradas</span>
                    <span className="font-code-md text-code-md text-on-surface">
                      16 <span className="font-body-sm text-[11px] text-primary">(16 ok)</span>
                    </span>
                  </div>
                  <div className="flex flex-col items-center">
                    <span className="font-body-sm text-[11px] text-secondary">Percurso</span>
            ...
            <div
              className="hidden flex-col items-center justify-center py-12 px-space-md text-center bg-surface-container-lowest rounded-lg"
              id="empty-state"
            >
              ...
              <p className="font-body-sm text-body-sm text-secondary max-w-[240px] mt-1">
                Verifique o código do romaneio ou limpe os filtros aplicados.
              </p>
              <button
                className="mt-4 px-5 h-11 rounded-full bg-surface-container text-on-surface font-label-md text-label-md"
                id="reset-filter-btn"
              >
                Limpar Busca
              </button>
            ...
            <div className="flex flex-col items-center text-center pt-space-xs pb-space-sm space-y-1">
              <span className="font-body-sm text-body-sm text-secondary">
                Exibindo 4 de 24 rotas de Outubro
              </span>
            ...
            <div className="w-full pt-1 pb-2">
              <button
                className="w-full h-14 rounded-full bg-surface-container-lowest text-primary hover:bg-surface-container-high active:bg-surface-container transition-all flex items-center justify-center gap-2 font-label-lg text-label-lg shadow-sm"
                id="export-pdf-btn"
              >
            ...
            <div
              className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm opacity-0 pointer-events-none transition-opacity duration-300 flex items-end"
              id="calendar-drawer"
            >
              <div className="w-full bg-surface-container-lowest rounded-t-xl p-space-lg max-h-[751px] overflow-y-auto transform translate-y-full transition-transform duration-300">
                ...
                <div className="pt-4 flex gap-3">
                  <button
                    className="w-full h-13 py-3 rounded-full bg-primary-container text-on-primary font-label-lg text-label-lg shadow-md"
                    id="apply-filter-btn"
                  >
                    Aplicar Filtro
                  </button>
            ...
            <div
              className="fixed bottom-24 inset-x-4 mx-auto max-w-sm bg-inverse-surface text-inverse-on-surface px-4 py-3 rounded-full shadow-lg flex items-center gap-3 opacity-0 pointer-events-none transition-all duration-300 z-50"
              id="toast-notify"
            >
              <span className="material-symbols-outlined text-tertiary-fixed text-[20px]">
                cloud_download
              </span>
              <span className="font-body-sm text-body-sm text-inverse-on-surface flex-1">
                Relatório gerado e enviado para seu email!
              </span>
            </div>
          </div>
        </main>
