...
export default function A2EsqueciMinhaSenhaOtp() {
  ...
  const fourthOtpDigitRef = useRef<HTMLInputElement | null>(null);
  useEffect(() => {
    document.title = 'A.2 Esqueci Minha Senha / Validação OTP - RotaPro Logística';
  }, []);
  useEffect(() => {
    fourthOtpDigitRef.current?.focus();
  }, []);
  return (
    <ScreenFrame screenId="a.2_esqueci_minha_senha_otp">
      {/* BEGIN: MobileDeviceFrame */}
      <div
        className="mobile-screen-wrapper flex flex-col justify-between"
        data-purpose="mobile-viewport-container"
      >
        {/* BEGIN: TopHeaderSection */}
        <header
          className="hero-gradient pt-8 pb-14 px-6 relative text-white"
        ...
        >
          ...
          <div className="flex items-center justify-between gap-2 mb-6">
            ...
            <button
              ...
              className="w-10 h-10 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-md flex items-center justify-center transition-colors active:scale-95 text-white"
              onClick={() => navigate(-1)}
              type="button"
            >
        ...
        <main
          className="-mt-8 px-4 z-10 flex-1 flex flex-col"
          data-purpose="recovery-workflow-card"
        >
          <div className="bg-white rounded-3xl p-6 shadow-xl border border-gray-100 flex flex-col flex-1">
            ...
            <div className="mb-6" data-purpose="step-indicator">
              <div className="flex items-center justify-between text-xs font-semibold mb-2">
                ...
                <span className="text-gray-400">3. Nova Senha</span>
              </div>
            ...
            <div
              className="bg-[#f2faf2] border border-green-200/70 rounded-2xl p-4 mb-6"
              data-purpose="phone-dispatch-info"
            >
              ...
              <div className="mt-2.5 pt-2.5 border-t border-green-200/50 flex justify-between items-center text-xs">
                ...
                <button className="text-brand font-semibold hover:underline" type="button">
                  Solicitar alteração
                </button>
              </div>
            </div>
            ...
            >
              <div className="space-y-4">
                <div>
                  ...
                  <div className="grid grid-cols-6 gap-2" data-purpose="otp-input-boxes">
                    <input
                      className="h-12 w-full text-center font-mono text-xl font-bold bg-gray-50 border border-gray-300 rounded-xl focus:border-brand focus:ring-2 focus:ring-brand/20 focus:bg-white text-gray-800 transition"
                      id="otp-digit-1"
                      maxLength={1}
                      type="text"
                      defaultValue="8"
                    ...
                    <input
                      ...
                      className="h-12 w-full text-center font-mono text-xl font-bold bg-gray-50 border border-brand ring-2 ring-brand/20 bg-white text-gray-800 transition"
                      maxLength={1}
                      ref={fourthOtpDigitRef}
                      type="text"
                      defaultValue="9"
                    />
                    <input
                      aria-label="Dígito 5 do código"
                      className="h-12 w-full text-center font-mono text-xl font-bold bg-gray-50 border border-gray-200 rounded-xl focus:border-brand focus:ring-2 focus:ring-brand/20 focus:bg-white text-gray-400 transition"
                      maxLength={1}
                      placeholder="•"
                      type="text"
                    />
                  ...
                  <div className="flex items-center justify-between mt-2.5 text-xs">
                    <span className="text-gray-500 font-medium">
                      Reenviar em: <strong className="text-gray-800 font-mono">00:45s</strong>
                    </span>
                    <button
                      className="text-gray-400 font-medium cursor-not-allowed flex items-center gap-1"
                      disabled
                      type="button"
                    >
                      <svg
                ...
                <div
                  ...
                  data-purpose="new-password-inputs"
                >
                  {/* Campo Nova Senha */}
                  <div>
                    <label
                    ...
                    <div className="relative">
                      ...
                      <input
                        className="w-full pl-10 pr-10 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-semibold text-gray-900 focus:bg-white focus:border-brand focus:ring-2 focus:ring-brand/20 transition"
                        id="nova-senha"
                        placeholder="Digite a nova senha"
                        type="password"
                        defaultValue="Motorista@2024"
                      />
                      <button
              ...
              <div className="space-y-2.5 pt-4">
                ...
                <button
                  className="w-full py-3.5 px-5 rounded-full bg-brand hover:bg-brand-dark active:scale-[0.98] text-white font-bold text-sm tracking-wide shadow-lg shadow-brand/30 flex items-center justify-center gap-2 transition-all"
                  type="submit"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                ...
                <button
                  className="w-full py-2.5 px-4 rounded-full text-xs font-semibold text-gray-500 hover:text-gray-800 hover:bg-gray-100 transition-colors"
                  onClick={() => navigate('/')}
                  type="button"
                >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-gray-900 leading-tight">
                  Central de Tráfego 24h
                </p>
              </div>
            </div>
            <a
              className="inline-flex items-center gap-1.5 py-2 px-3.5 rounded-xl bg-brand text-white font-bold text-xs shadow-sm hover:bg-brand-dark transition-all active:scale-95 flex-shrink-0"
              href="tel:0800000000"
            >
