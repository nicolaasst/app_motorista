...
export default function B2DetalheDaParada() {
  ...
  const handleCopyAddress = async () => {
    try {
      ...
      // Clipboard indisponível (sem permissão/HTTPS); sem feedback falso.
    }
  };
  ...
  return (
    <ScreenFrame screenId="b.2_detalhe_da_parada">
      <div>
        ...
        <main className="flex-1 flex flex-col relative w-full pt-16 pb-24 bg-surface px-margin">
          <div className="flex flex-col w-full pb-32">
            ...
            <div className="flex items-center justify-between py-space-sm mb-space-sm">
              <button
                aria-label="Voltar para rota do dia"
                className="w-11 h-11 rounded-full bg-surface-container-lowest shadow-sm flex items-center justify-center text-on-surface hover:bg-surface-container active:scale-95 transition-all"
                onClick={() => navigate(-1)}
                type="button"
              >
              ...
              <button
                aria-label="Opções e suporte da parada"
                className="w-11 h-11 rounded-full bg-surface-container-lowest shadow-sm flex items-center justify-center text-on-surface hover:bg-surface-container active:scale-95 transition-all"
                id="btnOptions"
              >
            ...
            <div className="relative w-full h-[168px] rounded-[20px] overflow-hidden shadow-sm bg-surface-container-high mb-space-md">
              <div
                ...
                data-location="Av. Paulista 1230, São Paulo, SP, Brasil"
              ...
              <a
                className="absolute bottom-3 right-3 h-10 px-4 rounded-full bg-primary-container hover:bg-primary text-on-primary shadow-md flex items-center gap-1.5 font-label-md text-label-md active:scale-95 transition-transform"
                href="https://maps.google.com/?q=Av.+Paulista+1230+Bela+Vista+Sao+Paulo"
            ...
            <div className="bg-surface-container-lowest rounded-[24px] p-space-md shadow-sm mb-space-md flex flex-col gap-3">
              <div className="flex items-start justify-between gap-space-sm">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-code-sm text-code-sm text-secondary tracking-wider mt-0.5">
                    CNPJ: 14.829.102/0001-45
                  </p>
                </div>
              ...
              <div className="bg-surface-container-low rounded-xl p-3 flex items-center justify-between gap-space-sm">
                ...
                <button
                  className="h-9 px-3 rounded-full bg-surface-container-lowest text-on-surface shadow-xs font-label-sm text-label-sm flex items-center gap-1 shrink-0 active:bg-surface-container-highest transition-colors"
                  id="btnCopyAddress"
              ...
              <div className="flex items-center justify-between px-1 py-1">
                ...
                <span className="font-code-md text-code-md text-on-surface bg-surface-container-low px-2.5 py-1 rounded-full">
                  14:00 - 14:30
                </span>
              </div>
              ...
              <div className="mt-1 pt-3 bg-surface-container-lowest rounded-2xl flex flex-col gap-2.5">
                ...
                <div className="grid grid-cols-2 gap-space-sm pt-1">
                  <a
                    className="h-[52px] rounded-full bg-primary-container text-on-primary font-label-lg text-label-lg flex items-center justify-center gap-2 shadow-sm active:scale-98 transition-transform"
                    href="https://wa.me/5511987654321?text=Ola%20Roberto,%20sou%20o%20motorista%20da%20RotaPro%20chegando%20com%20sua%20entrega"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                  ...
                  <a
                    className="h-[52px] rounded-full bg-[#131313] text-on-primary font-label-lg text-label-lg flex items-center justify-center gap-2 shadow-sm active:scale-98 transition-transform"
            ...
            <div className="flex flex-col gap-space-sm mb-space-md">
              <div className="flex items-center justify-between px-1">
                ...
                <span className="font-code-md text-code-md text-primary bg-surface-container-low px-2.5 py-1 rounded-md">
                  NF-e 89122-A
                </span>
              </div>
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h4 className="font-label-md text-label-md text-on-surface">
                        Caixa Padrão A - Medicamentos Refrigerados
                      </h4>
                      <p className="font-code-sm text-code-sm text-secondary">
                        EAN: 789100023411 • 4.2 kg
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-surface-container-lowest rounded-2xl p-space-md shadow-sm flex flex-col gap-2">
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h4 className="font-label-md text-label-md text-on-surface">
                        Caixa Padrão B - Suplementos e Vitaminas
                      </h4>
                      <p className="font-code-sm text-code-sm text-secondary">
                        EAN: 789100023412 • 6.8 kg
                      </p>
                    </div>
                  </div>
                  <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-primary-container/15 text-primary font-label-sm text-label-sm shrink-0">
              ...
              <div className="bg-surface-container-lowest rounded-2xl p-space-md shadow-sm flex flex-col gap-2">
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h4 className="font-label-md text-label-md text-on-surface">
                        Envelope Lacrado - Documentos Fiscais
                      </h4>
                      <p className="font-code-sm text-code-sm text-secondary">
                        EAN: 789100023413 • 0.3 kg
                      </p>
                    </div>
                  </div>
              ...
              <button
                className="h-[52px] rounded-full bg-surface-container-lowest text-primary font-label-lg text-label-lg shadow-sm flex items-center justify-center gap-2 active:bg-surface-container-low transition-colors mt-1"
                id="btnScannerTrigger"
              >
            ...
            <div className="bg-surface-container-low rounded-[20px] p-space-md shadow-xs mb-space-md flex items-start gap-3">
              ...
              <div className="flex flex-col">
                ...
                <p className="font-body-md text-body-md text-secondary mt-0.5">
                  Atenção: Acesso pela doca lateral na{' '}
                  <strong className="text-on-surface font-label-md">Rua Peixoto Gomide</strong>.
                  Exigir carimbo e assinatura física do responsável pelo recebimento.
                </p>
              </div>
            </div>
            {/* Ambient Micro-Feedback Toast (Hidden by default) */}
            <div
              className={`fixed top-20 left-1/2 -translate-x-1/2 z-50 bg-[#131313] text-on-primary px-4 py-2 rounded-full font-label-md text-label-md shadow-lg flex items-center gap-2 pointer-events-none transition-opacity duration-300 ${addressCopied ? 'opacity-100' : 'opacity-0'}`}
              id="copyToast"
            >
              <span className="material-symbols-outlined text-primary-container text-[18px]">
                done
            ...
            <div className="fixed bottom-[72px] inset-x-0 z-40 bg-surface/90 backdrop-blur-md px-margin py-3 shadow-[0_-4px_16px_rgba(0,0,0,0.08)] flex flex-col gap-2 max-w-lg mx-auto">
              <div className="flex items-center gap-space-sm">
                ...
                <button
                  className="flex-1 h-[54px] rounded-full bg-primary-container hover:bg-primary text-on-primary font-label-lg text-label-lg flex items-center justify-center gap-2 shadow-md active:scale-98 transition-all"
                  id="btnConfirmDelivery"
                  onClick={() => navigate(`/rota/parada/${stopId}/entrega`)}
                  type="button"
                >
                ...
                <button
                  aria-label="Registrar ocorrência ou insucesso"
                  className="h-[54px] px-5 rounded-full bg-error/10 text-error hover:bg-error-container active:scale-98 transition-all font-label-md text-label-md flex items-center justify-center gap-1.5 shrink-0"
                  id="btnReportIssue"
                  onClick={() => navigate(`/rota/parada/${stopId}/falha`)}
                  type="button"
                >
